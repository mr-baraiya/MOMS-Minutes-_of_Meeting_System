      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between p-4 border border-slate-200 rounded-md">
          <div>
            ...
            <p className="text-sm text-slate-600">Receive notifications for meeting invites and updates</p>
          </div>
          <input
            type="checkbox"
        ...
        <div className="flex items-center justify-between p-4 border border-slate-200 rounded-md">
          <div>
            <h3 className="font-medium">MOM Availability</h3>
            <p className="text-sm text-slate-600">Get notified when minutes of meetings are available</p>
          </div>
          <input
            type="checkbox"
            checked={settings.momAvailability}
            onChange={(e) => setSettings({ ...settings, momAvailability: e.target.checked })}
            className="w-5 h-5"
          />
        </div>
        ...
        <div className="flex items-center justify-between p-4 border border-slate-200 rounded-md">
          <div>
            <h3 className="font-medium">Attendance Marked Notification</h3>
            <p className="text-sm text-slate-600">Receive confirmation when your attendance is marked</p>
          </div>
          <input
            type="checkbox"
            checked={settings.attendanceMarkedNotification}
            onChange={(e) => setSettings({ ...settings, attendanceMarkedNotification: e.target.checked })}
            className="w-5 h-5"
          />
        </div>
      </div>
