          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-4">
                The Minutes of Meeting Management System is designed to
                streamline the entire meeting lifecycle - from scheduling to
                documentation and reporting.
              </p>
              <p className="text-lg text-gray-600 mb-4">
                Built with modern technology and best practices, our system
                ensures efficient collaboration, accurate record-keeping, and
                seamless management of all meeting-related activities.
              </p>
            ...
            <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl p-8 text-white">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-blue-100">Secure & Reliable</p>
                </div>
                <div>
                  <p className="text-4xl font-bold mb-2">24/7</p>
                  <p className="text-blue-100">Available Access</p>
                </div>
                <div>
                ...
                <div>
                  <p className="text-4xl font-bold mb-2">Easy</p>
                  <p className="text-blue-100">To Use</p>
                </div>
              </div>
            </div>
          </div>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Start managing your meetings more efficiently today. Try our demo
